...
\begin{document}
	...
	\referencias{referencias} % nome do arquivo BIB com as referências
	\nocite{EIA649B,abntex2classe,abntex2modelo-artigo,masolo2010,memoir} % O comando nocite é força a exibição de referências que não foram citadas
